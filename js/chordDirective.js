...
function ($window, matrixFactory) {
  ...
  var link = function ($scope, $el, $attr) {
    ...
    var colors = d3.scale.ordinal()
      .range(['#e57373','#F06292','#BA68C8','#9575CD','#7986CB','#64B5F6','#4FC3F7','#4DD0E1','#4DB6AC','#81C784','#b71c1c','#880E4F','#4A148C','#311B92','#1A237E','#0D47A1','#01579B','#006064','#004D40','#1B5E20']);
